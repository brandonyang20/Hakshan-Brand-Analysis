...
STATIC_DATA = {
    ...
    "recommendations": {
        "h1_quick_wins": [
            "Add Linktree to Instagram bio → link all 9 branches, menu, UMAI reservations",
            "Create Instagram Story Highlights: Menu | Branches | Charity | Reviews | Kitchen",
            "Claim & optimise all 9 Google Business profiles — add 20+ photos each",
    ...
    "chart_data": {
        ...
        "social_growth": {
            ...
            "instagram": [2100, 2310, 2510, 2771, 3100],
            "facebook":  [5190, 5470, 5790, 6257, 8000],
        },
        "brand_health_radar": {
